...
mod tests {
    ...
    fn self_tail_ref_loop(name: &str, recursive_arm: &str) -> String {
        format!(
            ": iszero ( i64 -- Bool ) 0 eq ;\n\
             : {name} ( 'T: Copy &!array['T 4] array['T 4] array['T 4] i64 -- i64 )\n\
             | r a b n |\n\
    ...
    fn setat_writes_an_element_through_a_poly_mutable_borrow() {
        ...
        // borrowed storage.
        check_src(
            ": setat ( ['T: Copy 4] 'T -- array['T 4] ) | a v | &!a 2 &!> v ! a ;\n\
    ...
    fn poly_reference_word_accepts_two_live_shared_borrows() {
        ...
        check_src(": twoshared ( ['T: Copy 4] -- array['T 4] ) | a | &a &a drop drop a ;\n")
    ...
    fn poly_call_term_accepts_naming_a_local_beside_a_live_shared_borrow() {
        ...
        check_src(
            ": sharedname ( ['T: Copy 4] -- array['T 4] 'T )\n  | a |\n  &a 0 &> @ | e |\n  &a a swap drop\n  e\n;\n",
        )
    ...
    fn poly_borrow_liveness_is_coarse_across_places() {
        ...
        let err = check_src(
            ": coarse ( ['T: Copy 4] array['T 4] 'T -- array['T 4] array['T 4] )\n  | a b v |\n  &b\n  &!a 0 &!> v !\n  &!a 1 &!> v !\n  drop a b\n;\n",
        )
        .unwrap_err();
        assert!(
            err.starts_with(
    ...
    fn poly_body_rejects_dup_of_a_mutable_borrow_and_accepts_dup_of_a_shared_one() {
        ...
        let err = check_src(
            ": dupmut ( ['T: Copy 4] 'T -- array['T 4] ) | a v | &!a dup 0 &!> v ! drop a ;\n",
        )
        .unwrap_err();
        assert_eq!(
            err,
        ...
        check_src(
            ": dupshared ( ['T: Copy 4] -- array['T 4] 'T ) | a | &a dup drop 0 &> @ | e | a e ;\n",
        )
    ...
    fn poly_body_store_rejects_a_shared_receiver() {
        ...
        let err =
            check_src(": rdstore ( ['T: Copy 4] 'T -- array['T 4] ) | a v | &a 0 &> v ! a ;\n")
                .unwrap_err();
        assert_eq!(
            err,
    ...
    fn poly_body_store_rejects_a_value_of_another_type() {
        ...
        let err = check_src(
            ": wrongval ( ['T: Copy 4] 'T -- array['T 4] ) | a v | &!a 0 &!> 5 ! v drop a ;\n",
        )
        .unwrap_err();
        assert_eq!(
            err,
