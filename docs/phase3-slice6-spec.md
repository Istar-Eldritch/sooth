...
| 17 | R21 over every aliasing route (naming, peek, peeked field both ways, array element, `if`-join, stack-side) plus naming-while-borrowed; `dup` fixes it; plain repeated naming still accepted | 2 |
