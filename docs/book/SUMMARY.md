...
- [Move by Default](./move-by-default.md)
...
- [Structs](./structs.md)
- [Enums](./enums.md)
- [Arrays and usize](./arrays-and-usize.md)

# References

- [Borrowing](./borrowing.md)
- [Projections](./projections.md)
- [What You Don't Have](./what-you-dont-have.md)

# The Heap

- [Owning Pointers](./owning-pointers.md)
- [Recursive Data](./recursive-data.md)
- [Disposal](./disposal.md)
- [FFI and Strings](./ffi-and-strings.md)

# Abstraction

- [Quotations and Loops](./quotations-and-loops.md)
