...
forward-declaration quirk, since fixed independently in `e5bd5a2` — criterion 8 no longer
needs a specific declaration order), and a golden-shape mismatch (the existing test this slice
