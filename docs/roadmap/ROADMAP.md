...
| **P7b** | [Higher-kinded types](./P7b-higher-kinded-types.md) | `[L]` — in progress (S1–S10, S8b, S8c, S11, S6d-PREREQ, S12 landed; follow-ups pending: S6d-PREREQ residuals (the DQ4 sentinel-substitution grounding route; the instantiation-audit exemption for synthesized bundles); S6d — slices as Iterator targets, deferred behind those residuals) |
