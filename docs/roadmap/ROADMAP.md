...
| **P7b** | [Higher-kinded types](./P7b-higher-kinded-types.md) | `[L]` — in progress (S1–S10 landed; follow-ups pending: S8b — the S6 wall fix + traitful `List` members; S8c — located fence for member signatures with unbindable free type variables; S6d — arrays as trait-impl constructors) |
