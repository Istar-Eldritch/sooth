...
| **P7b** | [Higher-kinded types](./P7b-higher-kinded-types.md) | `[L]` — in progress (S1–S8, S8b landed; follow-ups pending: S8c — located fence for member signatures with unbindable free type variables) |
